...
fun VentanaPalabras(navController: NavHostController,
    ...
    //val listasPalabrasPrueba by usuarioViewModel.tarjetasPrueba.collectAsState(initial = emptyList())
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(onClick = {
                Toast.makeText(context, "Iniciar Estudio", Toast.LENGTH_SHORT).show()
                ...
                AlertDialog(
                    ...
                    confirmButton = {
                        TextButton(onClick = {
                            ...
                            //usuarioViewModel.agregarTarjeta(nuevaPalabra)
